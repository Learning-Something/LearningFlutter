...
class ContactHelper {
  ...
  Future<Database> initDb() async {
    ...
    _db = await openDatabase(path, version: 1, onCreate: (Database db, int newerVersion) async {
      await db.execute(
  ...
  Future<List<Contact>> getAllContacts() async {
    ...
    listMap.forEach((Map contactMap) => listContacts.add(Contact.fromMap(contactMap)));
    return listContacts;
  }
